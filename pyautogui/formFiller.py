...
From Al Sweitgart's Automate the Boring Stuff Chapter 20:  https://automatetheboringstuff.com/2e/chapter20/
"""
...
for person in formData:
	...
	# Use the following command to find coordinates of the submit button from a image of the button.
	# >>> import pyautogui
	# >>> b = pyautogui.locateOnScreen('submit.png')
	# Box(left=574, top=694, width=427, height=32)
	submitAnotherLink = (574, 694)

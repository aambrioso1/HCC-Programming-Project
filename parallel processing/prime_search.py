...
# rank = 0 # I introduced this variable.  The main core is rank 0 and all other core ranks are arbitrary
...
# totalnodes = 8  # my variable
results = [] # needs to have wider scope since program is serial

while numstested < MAXTOTEST:
	#  The main core creates an inner list
	#  
	if rank==0:
		mylist = []
	...
	# scatter must automatically send each element of my list to a different node
	...
	# My code to turn this into serial code
	#  result = []
	"""
	for inn in mylist:
		# results = []
		for p in range(inn[0], inn[1]):
